 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://webservice.testserviceapp.apm.dell.com/", wsdlLocation = "file:/d:/workspace/Spiderman/src/APMTestProject/APMTestWebAPP/src/main/webapp/META-INF/wsdl/SayHello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://webservice.testserviceapp.apm.dell.com/", "SayHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/d:/workspace/Spiderman/src/APMTestProject/APMTestWebAPP/src/main/webapp/META-INF/wsdl/SayHello.wsdl");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://webservice.testserviceapp.apm.dell.com/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.testserviceapp.apm.dell.com/", "SayHelloPort"), SayHello.class, features);
    }
